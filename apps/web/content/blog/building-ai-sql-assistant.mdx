...
*This is how we built the AI assistant in data-peek. The code is [open source](https://github.com/Rohithgilla12/data-peek) - check out the implementation in `src/main/ai-service.ts` and `src/renderer/src/components/ai/`.*
